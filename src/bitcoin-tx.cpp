...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("e-Gulden Core egulden-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  egulden-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded egulden transaction") + "\n" +
              "  egulden-tx [options] -create [commands]   " + _("Create hex-encoded egulden transaction") + "\n" +
              "\n";
