...
std::string HelpMessageCli()
{
    ...
    strUsage += "  -conf=<file>           " + strprintf(_("Specify configuration file (default: %s)"), "egulden.conf") + "\n";
...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("e-Gulden Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  egulden-cli [options] <command> [params]  " + _("Send command to e-Gulden Core") + "\n" +
                  "  egulden-cli [options] help                " + _("List commands") + "\n" +
                  "  egulden-cli [options] help <command>      " + _("Get help for a command") + "\n";
