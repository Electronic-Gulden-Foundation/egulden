...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to an e-Gulden address"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible e-Gulden command-line options").arg(tr(PACKAGE_NAME)));
